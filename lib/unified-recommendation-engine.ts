...
export interface UnifiedRecommendation {
  // Core recommendations (from original engine)
  weakAreas: string[]
  strongAreas: string[]
  ...
  // Advanced analytics (from smart engine)
  ...
  // Personalized insights (from smart engine)
  ...
  // Adaptive features (from smart engine)
...
export class UnifiedRecommendationEngine {
  ...
  /**
   * Main recommendation generation method - combines both engines
   */
  async generateUnifiedRecommendations(
    ...
    try {
      // Try AI-powered recommendations first (from original engine)
      ...
      // Generate performance analytics (from smart engine)
      ...
      // Generate personalized insights (from smart engine)
      ...
      // Generate adaptive recommendations (from smart engine)
  ...
  /**
   * AI-powered recommendation generation (from original engine)
   */
  private async generateAIRecommendations(
    ...
    userHistory: QuizResult[],
    user?: User
  ): Promise<Partial<UnifiedRecommendation>> {
  ...
  /**
   * Get recommended learning resources (from original engine)
   */
  ...
  private generateNextQuizSuggestion(
    ...
    userHistory: QuizResult[],
    percentage: number
  ): UnifiedRecommendation["nextQuizSuggestion"] {
  ...
  private analyzePerformance(
    ...
    questions: Question[],
    userHistory: QuizResult[]
  ): UnifiedRecommendation["performanceAnalytics"] {
  ...
  private async generatePersonalizedInsights(
    userHistory: QuizResult[],
    performanceAnalytics: UnifiedRecommendation["performanceAnalytics"],
    user?: User
  ): Promise<UnifiedRecommendation["personalizedInsights"]> {
  ...
  private generateAdaptiveRecommendations(
    ...
    userHistory: QuizResult[],
    performanceAnalytics: UnifiedRecommendation["performanceAnalytics"]
  ): UnifiedRecommendation["adaptiveRecommendations"] {
  ...
  /**
   * Legacy compatibility method - maintains backward compatibility with original engine
   */
  async generatePersonalizedRecommendations(
    ...
    return {
      weakAreas: unifiedRecommendations.weakAreas,
      strongAreas: unifiedRecommendations.strongAreas,
      recommendedResources: unifiedRecommendations.recommendedResources,
      nextQuizSuggestion: {
        category: unifiedRecommendations.nextQuizSuggestion.category,
        difficulty: unifiedRecommendations.nextQuizSuggestion.difficulty,
        reason: unifiedRecommendations.nextQuizSuggestion.reason
      },
      pathRecommendations: unifiedRecommendations.pathRecommendations,
      studyPlan: unifiedRecommendations.studyPlan
    }
  }

  /**
   * Track learning progress over time (from original engine)
   */
  analyzeProgressTrend(userHistory: QuizResult[]): {
...
export const generatePersonalizedRecommendations = unifiedRecommendationEngine.generatePersonalizedRecommendations.bind(unifiedRecommendationEngine)
export const analyzeProgressTrend = unifiedRecommendationEngine.analyzeProgressTrend.bind(unifiedRecommendationEngine) 