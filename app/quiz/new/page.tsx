...
import { ArrowRight, Clock, BarChart3, Brain } from "lucide-react"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Set the time limit for each individual question</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 gap-2">
                    {timeLimits.map((time) => (
                      <Button
                        ...
                        className="text-sm"
                      >
                        {time === 0 ? "No Limit" : `${time}s per question`}
                      </Button>
                    ))}
                  </div>
                </CardContent>
