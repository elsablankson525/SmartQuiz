...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.subject.createMany({
            data: [
                { name: 'Computer Science', description: 'Programming, algorithms, data structures, and software engineering', icon: '💻', color: 'bg-blue-100 text-blue-700' },
                { name: 'Health & Medicine', description: 'Medical knowledge, anatomy, pharmacology, and healthcare practices', icon: '🏥', color: 'bg-green-100 text-green-700' },
                { name: 'Business & Management', description: 'Business strategy, management, finance, and entrepreneurship', icon: '💼', color: 'bg-purple-100 text-purple-700' },
                { name: 'Law & Legal Studies', description: 'Legal principles, constitutional law, contracts, and jurisprudence', icon: '⚖️', color: 'bg-amber-100 text-amber-700' },
                { name: 'Psychology', description: 'Human behavior, cognitive science, and psychological theories', icon: '🧠', color: 'bg-pink-100 text-pink-700' },
                { name: 'Mathematics', description: 'Algebra, calculus, statistics, and mathematical reasoning', icon: '📊', color: 'bg-indigo-100 text-indigo-700' },
                { name: 'JavaScript', description: 'JavaScript programming language', icon: '💻', color: 'bg-blue-100' },
                { name: 'Python', description: 'Python programming language', icon: '🐍', color: 'bg-green-100' },
            ]
        });
        // Learning Paths
        const learningPaths = yield prisma.learningPath.createMany({
            data: [
                { title: 'Web Development Fundamentals', description: 'Master the basics of web development with HTML, CSS, and JavaScript', category: 'Computer Science', difficulty: 'Beginner', estimatedDuration: '6 weeks', prerequisites: ['Basic computer skills'], progress: 0, isActive: true },
                { title: 'Introduction to Data Science', description: 'Learn data analysis, visualization, and machine learning basics', category: 'Computer Science', difficulty: 'Intermediate', estimatedDuration: '8 weeks', prerequisites: ['Python Programming', 'Mathematics'], progress: 25, isActive: true },
            ]
        });
        ...
        yield prisma.question.createMany({
            data: [
                { id: 'q1', question: 'What is the output of console.log(typeof NaN)?', options: ["'number'", "'NaN'", "'undefined'", "'object'"], correctAnswer: "'number'", explanation: "In JavaScript, NaN (Not a Number) is actually of type 'number'.", difficulty: 'intermediate', topic: 'javascript', relatedConcepts: ['data types', 'type coercion', 'NaN'] },
                { id: 'q2', question: 'Which method adds elements to the end of an array?', options: ['push()', 'pop()', 'unshift()', 'shift()'], correctAnswer: 'push()', explanation: 'The push() method adds one or more elements to the end of an array.', difficulty: 'beginner', topic: 'javascript', relatedConcepts: ['arrays', 'methods', 'data manipulation'] },
            ]
        });
        // Note: Leaderboard entries require valid user IDs and will be created dynamically
        // when users take quizzes and the leaderboard updater runs
        // Note: Achievement and StudyPlan models are not in the current schema
    });
}
main()
    .then(() => {
