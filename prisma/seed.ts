...
async function main() {
  ...
  const subjects = [
    ...
    { name: 'Engineering Fundamentals', icon: '🛠️', description: 'Core engineering concepts.', color: 'bg-gray-100', borderColor: 'border-gray-200', topics: ['engineering', 'mechanical engineering', 'electrical engineering'], quizzes: 3, learners: 500, avgTime: '2 weeks', difficulty: 'Beginner', rating: 4.7 },
    { name: 'Arts & Humanities Overview', icon: '🎨', description: 'History, literature, and philosophy.', color: 'bg-pink-100', borderColor: 'border-pink-200', topics: ['arts-humanities', 'history', 'literature', 'philosophy'], quizzes: 3, learners: 400, avgTime: '2 weeks', difficulty: 'Beginner', rating: 4.6 },
    { name: 'Natural Sciences Basics', icon: '🔬', description: 'Physics, chemistry, and biology.', color: 'bg-green-100', borderColor: 'border-green-200', topics: ['natural-sciences', 'physics', 'chemistry', 'biology'], quizzes: 3, learners: 450, avgTime: '2 weeks', difficulty: 'Beginner', rating: 4.8 },
    { name: 'Social Sciences Essentials', icon: '🌍', description: 'Sociology, economics, and politics.', color: 'bg-blue-100', borderColor: 'border-blue-200', topics: ['social-sciences', 'sociology', 'economics', 'politics'], quizzes: 3, learners: 420, avgTime: '2 weeks', difficulty: 'Beginner', rating: 4.7 },
    { name: 'Technology Foundations', icon: '🤖', description: 'AI, cybersecurity, and data science.', color: 'bg-indigo-100', borderColor: 'border-indigo-200', topics: ['technology', 'ai', 'cybersecurity', 'data-science'], quizzes: 3, learners: 480, avgTime: '2 weeks', difficulty: 'Beginner', rating: 4.9 },
  ];
